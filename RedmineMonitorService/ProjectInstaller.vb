...
Public Class ProjectInstaller
    ...
    Public Sub New()
        ...
        serviceInstaller.ServiceName = "RedmineMonitorService"
        serviceInstaller.DisplayName = "Redmine Monitor Service"
        serviceInstaller.Description = "Monitors Redmine tickets and generates HTML reports"
